...
First citation: \cite{vaswani2017attention} % dovrebbe essere [1]

Second: \cite{brown2020language} % [2]

Third: \cite{bubeck2023sparks} % [3]

Fourth: \cite{chowdhery2022palm} % [4]

Fifth: \cite{openai2023gpt4} % [5]
